                        ...
                        <div class="card card-flush">
                            ...
                            <div class="card-header mt-6">
                                ...
                                <div class="card-toolbar">
                                    <!--begin::Button-->
                                    <a type="button" class="btn btn-light-primary"  href="{{ route('create-user') }}">
                                        ...
                                        <!--end::Svg Icon-->Registrar Nuevo Usuario
                                    </a>
                                    <!--end::Button-->
                                </div>
                                <!--end::Card toolbar-->
                                        ...
                                        <table
                                            ...
                                            <thead>
                                                ...
                                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="min-w-125px sorting">Nombre</th>
                                                    <th class="min-w-250px sorting_disabled" rowspan="1" colspan="1"
                                                        aria-label="Assigned to" style="width: 343.406px;">Rol
                                                    </th>
                                            ...
                                            @foreach ($users as $index => $user)
                                                <tr class="odd">
                                                    ...
                                                    <td class="text-end">
                                                        <div class="btn-group">
                                                            <a href="{{ route('edit-user', $user['id']) }}" class="btn btn-primary btn-sm">Editar</a>
